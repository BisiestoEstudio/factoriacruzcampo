...
export default function Edit() {
	...
	return (
		<section { ...blockProps }>
			<div className="b-experience-header__wrapper">
				<h1 className="b-experience-header__title">
